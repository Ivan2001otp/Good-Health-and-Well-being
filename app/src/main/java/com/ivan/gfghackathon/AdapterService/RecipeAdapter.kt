...
class RecipeAdapter(var recipeList:List<Recipe>) : RecyclerView.Adapter<RecipeAdapter.RecipeViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecipeViewHolder, position: Int) {
        holder.itemView.apply{
            this.findViewById<TextView>(R.id.row_carbs_tv).text = recipeList.get(position).carbs
            this.findViewById<TextView>(R.id.row_fat_tv).text = recipeList.get(position).fats
            this.findViewById<TextView>(R.id.row_cal_tv).text = recipeList.get(position).calorie
            this.findViewById<TextView>(R.id.row_proteins_tv).text = recipeList.get(position).protein
